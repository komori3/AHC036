...
if __name__ == "__main__":
    ...
    for tag in os.listdir(SUBMISSIONS_DIR):
        ...
        with open(results_file) as f:
            tag_to_results[tag] = yaml.safe_load(f)

    seed_to_best_score = defaultdict(lambda: 10**20)
    ...
    for tag, results in tag_to_results.items():
        ...
        for result in results:
            ...
            tag_to_total_score[tag] += seed_to_best_score[seed] / score
    ...
    # for e in seed_to_unique_tag.items():
    #     print(e)